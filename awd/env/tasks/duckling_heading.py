...
class DucklingHeading(duckling_amp_task.DucklingAMPTask):
    ...
    def pre_physics_step(self, actions):
        ...
        self._prev_root_pos[:] = self._duckling_root_states[..., 0:3]
        return
    
    def _update_marker(self):
        duckling_root_pos = self._duckling_root_states[..., 0:3]
        self._marker_pos[..., 0:2] = duckling_root_pos[..., 0:2] + self._tar_dir
        ...
        self._face_marker_pos[..., 0:2] = duckling_root_pos[..., 0:2] + self._tar_facing_dir
    ...
    def _load_marker_asset(self):
        asset_root = "awd/data/assets/mjcf/"
    ...
    def _build_marker_state_tensors(self):
        ...
        self._marker_actor_ids = self._duckling_actor_ids + TAR_ACTOR_ID
        ...
        self._face_marker_actor_ids = self._duckling_actor_ids + TAR_FACING_ACTOR_ID
    ...
    def _compute_task_obs(self, env_ids=None):
        if (env_ids is None):
            root_states = self._duckling_root_states
            tar_dir = self._tar_dir
            tar_speed = self._tar_speed
            tar_face_dir = self._tar_facing_dir
        else:
            root_states = self._duckling_root_states[env_ids]
